...
int Fun4All_pi0_simple_evnt_gen_sPHENIX(
    const int nEvents = 10,
    const string &outputFile = "G4sPHENIX_10evt_w_embed.root",
    ...
    const string &outdir = ".")
{
  ...
  if (Input::SIMPLE)
  {
    INPUTGENERATOR::SimpleEventGenerator[0]->add_particles("pi0",2);  //(pid, 2);
